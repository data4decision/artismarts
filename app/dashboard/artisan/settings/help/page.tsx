...
const help = [
  {
    ...
    href: "/dashboard/artisan/settings/help/product-feature",
    icon: FaLightbulb
  },
  {
    id: "technical",
    ...
    href: "/dashboard/artisan/settings/help/technical",
    icon: FaTools
  },
  {
    id: "help",
    ...
    href: "/dashboard/artisan/settings/help/need-help",
    icon: FaInfoCircle
  },
  {
    id: "faq",
    ...
    href: "/dashboard/artisan/settings/help/faq",
  ...
  return (
    <div className='max-w-4xl mx-auto p-6'> 
        <div className="flex items-center gap-3 mb-8">
          <Link href='/dashboard/artisan/settings' className="flex items-center gap-4">
