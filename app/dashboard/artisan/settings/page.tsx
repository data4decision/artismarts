...
const Page = () => {
  ...
  const [selectedSound, setSelectedSound] = React.useState('/sounds/dragon-bell.mp3')
  const [savedSound, setSavedSound] = React.useState('/sounds/dragon-bell.mp3')
...
useEffect(() => {
  const loadedSound = localStorage.getItem('notificationSound') || '/sounds/dragon-bell.mp3'
