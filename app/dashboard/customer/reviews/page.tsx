...
// app/dashboard/customer/reviews/page.tsx  ← change to .tsx if it has JSX

// components/review/CustomerReviewForm.tsx

interface CustomerReviewFormProps {
  artisanId: string;
  // add other props if needed, e.g.
  // onSubmit?: (data: ReviewData) => void;
  // className?: string;
}

// app/dashboard/customer/reviews/page.tsx   ← rename to .tsx if it contains JSX

// import CustomerReviewForm from '@/components/review/CustomerReviewForm'
...
//       <CustomerReviewForm artisanId={artisanId} />
//     </div>
//   )
// }
