...
// const defaultCenter = { lat: 8.9667, lng: 4.5667 }; // Ilorin, Kwara
...
//     const channel = supabase
//       .channel(`google-map-${jobRequestId}`)
//       .on(
//         'postgres_changes',
//         {
//           event: '*',
...
//         {address && (
//           <div className="absolute bottom-4 left-4 bg-white p-3 rounded-lg shadow-lg text-sm max-w-[250px]">
