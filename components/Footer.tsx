  ...
  return (
    ...
    <div className='bg-[var(--blue)] grid grid-cols-1 sm:grid-cols-4 px-10 py-8 sm:py-12 gap-5 border-t-[5px] border-t-[var(--orange)] border-radius-tl-[20px] border-radius-tr-[20px] rounded-tl-[20px] rounded-tr-[20px]'>
        <div className="">
            ...
            <p className='text-[var(--white)] font-semibold text-sm sm:text-sm mt-4 pr-4'>ArtiSmart connects you with trusted, verified artisans for reliable, on-demand services while supporting their sustainable income.</p>
            <div className="flex flex-col space-y-4 mt-4 ">
                <Link href="#" className="text-[var(--white)] hover:text-[var(--orange)] flex gap-2 items-center"><FaFacebook/>Facebook</Link>
                <Link
                  href="#"
                ...
                <Link href="#" className="text-[var(--white)] hover:text-[var(--orange)] flex gap-2 items-center">
        ...
        <div>
          ...
          <ul className='text-[var(--white)] font-semibold text-sm sm:text-sm mt-4 space-y-2'>
        ...
        <div className="text-[var(--white)] font-bold text-xl sm:text-2xl">
