    ...
    <div className="min-h-screen bg-gray-50 py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8 md:space-y-12">
        ...
        <div className="px-10 py-4">
          ...
          <p className="text-[var(--blue)] max-w-2xl mx-auto text-base sm:text-[15px] ">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
              ...
              {!isEditMode ? (
                <button
                  ...
                  className="px-4 py-2.5 bg-[var(--orange)] text-white rounded-lg font-medium hover:bg-[var(--blue)] transition flex items-center justify-center gap-2 w-full sm:w-auto"
                >
                  <FaEdit />
                  Edit Portfolio
                </button>
