...
export default function MobileFeaturedAppRating() {
  ...
  const settings = {
    ...
    speed: 600,
    slidesToShow: 1,           // Default to 1 on mobile
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 5000,
    pauseOnHover: true,
  ...
  return (
    <div className="lg:hidden bg-white py-20">   {/* Shows only on mobile */}
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-[var(--blue)]">
            Testimonials
          </h2>
        </div>
            ...
            {testimonials.map((testimonial) => (
              <div key={testimonial.id} className="px-3">
                <div className="bg-white border-2 border-[var(--blue)] hover:border-[var(--orange)] 
                                rounded-3xl shadow-md hover:shadow-2xl p-8 h-[320px] 
                  ...
                  {/* Comment */}
                  <p className="text-gray-700 italic leading-relaxed flex-1 text-[15.5px] overflow-auto">
                    “{testimonial.comment}”
                  </p>
                </div>
              </div>
