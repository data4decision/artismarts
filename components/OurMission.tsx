    ...
    <div className='font-roboto py-20 mt-20'>
        <div className="grid grid-cols-1 md:grid-cols-2 w-[80%] m-auto bg-[var(--blue)]/30 rounded-lg">
            <div className="px-5 py-5 ">
                ...
                <p className="text-[15px]  text-[var(--white)]">To empower artisans by providing a vibrant digital platform that connects their exceptional skills with a global audience, while fostering creativity, sustainability, and fair economic opportunities.</p>
                ...
                <p className="text-[15px]  text-[var(--white)]">A world where every artisan is celebrated, their skills are valued with modern innovation in a sustainable and inclusive marketplace.</p>
            </div>
