    ...
    <div className='font-roboto py-20 mt-20'>
        <div className="grid grid-cols-1 md:grid-cols-2 w-[80%] m-auto bg-[var(--blue)]/30 rounded-lg">
            <div className="px-5 py-5 ">
                <p className="text-xl lg:text-4xl md:text-4xl font-bold text-[var(--orange)] mt-4">About Us</p>
                <h1 className="text-2xl lg:text-3xl lg:w-[60%] md:text-3xl font-bold leading-tight text-[var(--white)]">Reliability. Trust. Accessibility.</h1>
                <p className="text-[15px]  text-[var(--white)]">ArtiSmart is a trusted digital platform that connects customers with skilled, verified artisans, making it easier than ever to access reliable services when and where you need them. We remove the uncertainty of finding dependable artisans while creating sustainable income opportunities for professionals across diverse trades.</p>
                <p className="text-xl lg:text-4xl md:text-3xl font-bold text-[var(--orange)] mb-2 mt-2">Our Mission</p>
                <p className="text-[15px]  text-[var(--white)]">To empower artisans by providing a vibrant digital platform that connects their exceptional craftsmanship with a global audience, while fostering creativity, sustainability, and fair economic opportunities.</p>
                ...
                <p className="text-[15px]  text-[var(--white)]">A world where every artisan is celebrated, their skills are valued, and traditional craftsmanship thrives alongside modern innovation in a sustainable and inclusive marketplace.</p>
            </div>
