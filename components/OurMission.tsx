...
const OurMission = () => {
  return (
    <div className='font-roboto sm:py-20 py-5 sm:mt-20 bg-[var(--blue)] '>
        <div className="max-w-6xl m-auto grid grid-cols-1 md:grid-cols-2 sm:w-full w-full m-auto bg-[var(--blue)] sm:rounded-lg">
            <div className="px-5 py-5 ">
                ...
                <p className="text-[10px] md:text-[16px] text-[var(--white)]">ArtiSmart is a trusted digital platform that connects customers with skilled, verified artisans, making it easier than ever to access reliable services when and where you need them. We remove the uncertainty of finding dependable artisans while creating sustainable income opportunities for professionals across diverse trades.</p>
                <p className="text-xl lg:text-4xl md:text-3xl font-bold text-[var(--orange)] mb-2 mt-2">Our Mission</p>
                <p className="text-[10px] md:text-[16px]  text-[var(--white)]">To empower artisans by providing a vibrant digital platform that connects their exceptional skills with a global audience, while fostering creativity, sustainability, and fair economic opportunities.</p>
                ...
                <p className="text-[10px] md:text-[16px]  text-[var(--white)]">A world where every artisan is celebrated, their skills are valued with modern innovation in a sustainable and inclusive marketplace.</p>
            </div>
