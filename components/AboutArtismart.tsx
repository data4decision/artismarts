  ...
  return (
    <div className="font-roboto">
        ...
        <div className="absolute top-1/2 -translate-y-1/2  ">
            ...
            <p className='bg-[var(--blue)] text-[var(--white)] sm:text-xl text-sm sm:ml-20  font-semibold mt-3 rounded-lg border-b-3 border-r-0 border-l-0 border-t-0 border-[var(--orange)] px-4 py-4'>Empowering Creativity Through Innovation and Craft</p>
