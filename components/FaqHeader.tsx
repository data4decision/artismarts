  ...
  return (
    <div className="font-roboto  z-10">
        ...
        <div className="absolute  top-1/2 -translate-y-1/2  ">
            <h1 className='sm:text-2xl text-xl text-[var(--blue)] font-bold bg-[var(--white)] w-[350px] sm:ml-20 ml-10  px-4 py-3 rounded-lg border-b-3 border-r-0 border-l-0 border-t-0 border-[var(--blue)]  '>
